    ...
    if (page === 'blackbox_insurance') {
        ...
        content.innerHTML = `<h3><i class="fa-solid fa-box-archive"></i> ${t.title}</h3>
            ...
            ` : `<p style="text-align:center; color:#444; padding:30px;">${t.nodata}</p>`}
                ...
                <button onclick="if(confirm('Supprimer définitivement toutes vos données de conduite ?')){ sessionStorage.removeItem('blackbox_last_ride'); localStorage.clear(); location.reload(); }" style="width:100%; margin-top:15px; background:none; border:1px solid #c0392b; color:#c0392b; padding:8px; border-radius:8px;             'fr            'fr': { rTitle: "=== RAPPORT BLACK BOX mon50ccetmoi ===", rDate: "Date :", rPts: "Points enregistrés :", rMaxSpd: "Vitesse maximum :", rStart: "Départ GPS :", rEnd: "Arrivée GPS :", rGen: "Ce rapport est généré par l'application mon50ccetmoi.", rContact: "Pour toute expertise assurance, contactez : contact@mon50ccetmoi.com", rEndTxt: "=== FIN DU RAPPORT ===" },
            'en': { rTitle: "=== mon50ccetmoi BLACK BOX REPORT ===", rDate: "Date:", rPts: "Recorded points:", rMaxSpd: "Maximum speed:", rStart: "GPS Start:", rEnd: "GPS End:", rGen: "This report is generated by the mon50ccetmoi application.", rContact: "For insurance expertise, contact: contact@mon50ccetmoi.com", rEndTxt: "=== END OF REPORT ===" },
            'es': { rTitle: "=== INFORME BLACK BOX mon50ccetmoi ===", rDate: "Fecha:", rPts: "Puntos registrados:", rMaxSpd: "Velocidad máxima:", rStart: "Salida GPS:", rEnd: "Llegada GPS:", rGen: "Este informe es generado por la aplicación mon50ccetmoi.", rContact: "Para peritajes de seguros, contacto: contact@mon50ccetmoi.com", rEndTxt: "=== FIN DEL INFORME ===" },
            'it': { rTitle: "=== RAPPORTO BLACK BOX mon50ccetmoi ===", rDate: "Data:", rPts: "Punti registrati:", rMaxSpd: "Velocità massima:", rStart: "Partenza GPS:", rEnd: "Arrivo GPS:", rGen: "Questo rapporto è generato dall'applicazione mon50ccetmoi.", rContact: "Per perizie assicurative, contattare: contact@mon50ccetmoi.com", rEndTxt: "=== FINE DEL RAPPORTO ===" },
            'de': { rTitle: "=== BLACK BOX BERICHT mon50ccetmoi ===", rDate: "Datum:", rPts: "Aufgezeichnete Punkte:", rMaxSpd: "Höchstgeschwindigkeit:", rStart: "GPS Start:", rEnd: "GPS Ziel:", rGen: "Dieser Bericht wurde von der App mon50ccetmoi erstellt.", rContact: "Für Versicherungsfragen kontaktieren Sie: contact@mon50ccetmoi.com", rEndTxt: "=== ENDE DES BERICHTS ===" }eElement('a');
